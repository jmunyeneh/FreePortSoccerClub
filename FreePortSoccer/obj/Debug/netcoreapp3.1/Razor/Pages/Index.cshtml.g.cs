#pragma checksum "C:\Users\JaydenExpress\source\repos\Projects\FreePortClub\FreePortSoccer\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f027249244a29e7657cd509616a1e48824cd80b6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f027249244a29e7657cd509616a1e48824cd80b6", @"/Pages/Index.cshtml")]
   ...
   ");
        ...
        <div class=""row"">
            ...
            WriteLiteral(@"small country"">Brazil</span>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center text-lg-right"">
                                            <div");
            BeginWriteAttribute("class", " class=\"", 10762, "\"", 10770, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
     ...
     ");
            WriteLiteral(@"                                           </div>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center text-lg-right"">
                                            <div");
            BeginWriteAttribute("class", " class=\"", 22258, "\"", 22266, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
                                                    <div class=""image image-small ml-lg-3 mb-3 mb-lg-0 order-2"">
       ...
       ");
            WriteLiteral(@"                                         </div>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center text-lg-right"">
                                            <div");
            BeginWriteAttribute("class", " class=\"", 25041, "\"", 25049, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
                                                    <div class=""image image-small ml-lg-3 mb-3 mb-lg-0 order-2"">
          ...
          ");
            ...
            WriteLiteral(@"div>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center tex");
            WriteLiteral("t-lg-right\">\r\n                                            <div");
            BeginWriteAttribute("class", " class=\"", 28184, "\"", 28192, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
                                                    <div class=""image image-small ml-lg-3 mb-3 mb-lg-0 order-2"">
     ...
     ");
            WriteLiteral(@"                                           </div>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center text-lg-right"">
                                            <div");
            BeginWriteAttribute("class", " class=\"", 30969, "\"", 30977, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
                                                    <div class=""image image-small ml-lg-3 mb-3 mb-lg-0 order-2"">
       ...
       ");
            WriteLiteral(@"                                         </div>
                                        ...
                                        <div class=""col-md-4 col-lg-4 text-center text-lg-right"">
                                            <div");
            BeginWriteAttribute("class", " class=\"", 33752, "\"", 33760, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                <div class=""d-block d-lg-flex align-items-center"">
                                                    <div class=""image image-small ml-lg-3 mb-3 mb-lg-0 order-2"">
