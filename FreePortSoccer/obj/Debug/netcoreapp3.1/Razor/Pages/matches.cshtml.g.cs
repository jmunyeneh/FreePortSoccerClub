#pragma checksum "C:\Users\JaydenExpress\source\repos\Projects\FreePortClub\FreePortSoccer\Pages\matches.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "35fa17671817795481b354b2805718e2e12ccd86"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"35fa17671817795481b354b2805718e2e12ccd86", @"/Pages/matches.cshtml")]
      ...
      <div class=""container"">
        <div class=""row"">
          ...
          <div class=""row align-items-center"">
            <div class=""");
            WriteLiteral(@"col-md-12 col-lg-4 mb-4 mb-lg-0"">
            ...
            <div class=""col-md-12 col-lg-4 text-center mb-4 mb-lg-0"">
              <div class=""d-inline-block"">
                ...
                <p class=""mb");
            WriteLiteral("-0\"><small class=\"text-uppercase text-black font-weight-bold\">10 September / 7:30 AM</small></p>\r\n              </div>\r\n            </div>\r\n\r\n            <div class=\"col-md-12 col-lg-4 text-center text-lg-right\">\r\n              <div");
        ...
        <div class=""row mb-5"">
          <div class=""col-md-12"">
            <div class=""border mb-3 rounded d-block d-lg-flex align-items-center p-3 next-match"">
              ...
              <div class=""ml-auto pr-4 order-m");
            WriteLiteral(@"d-2"">
        ...
        <div class=""row align-items-center mb-5"">
          <div class=""col-md-12"">
            ...
            ");
            WriteLiteral(@"  <div class=""col-md-4 col-lg-4 mb-4 mb-lg-0"">
              ...
              <div class=""col-md-4 col-lg-4 mb-4 mb-lg-0"">
                ...
                <div class=""text-center text-lg-left"">
                  <div class=""d-block d-lg-flex align-items-center"">
                    <div class=""image image-small text-center mb-3 mb-lg-0 mr-lg-3"">
                      <img src=""images/i");
            WriteLiteral(@"mg_1_sq.jpg"" alt=""Image"" class=""img-fluid"">
                    </div>
                    <div class=""text"">
              ...
              <div class=""col-md-4 col-lg-4 mb-4 mb-lg-0"">
                ...
                <div class=""text-center text-lg-left"">
                  <div class=""d-block d-lg-flex align-items-center"">
                    <div class=""image image-small text-center mb-3 mb-lg-0 mr-lg-3"">
                      <img src=""images/im");
            WriteLiteral(@"g_1_sq.jpg"" alt=""Image"" class=""img-fluid"">
                    </div>
                    <div class=""text"">
              ...
              <div class=""col-md-4 col-lg-4 mb-4 mb-lg-0"">
                ...
                <div class=""text-center text-lg-left"">
                  <div class=""d-block d-lg-flex align-items-center"">
                    <div class=""image image-small text-center mb-3 mb-lg-0 mr-lg-3"">
                      <img src=""images/img");
            WriteLiteral(@"_1_sq.jpg"" alt=""Image"" class=""img-fluid"">
                    </div>
                    <div class=""text"">
                      <h3 class=""h5 mb-0 text-black"">Packers</h3>
                      <span class=""text-uppercase small country"">Brazil</span>
